...
class MockDatabase {
  constructor() {
    ...
    this.mensagensParcerias = [
      { id: 1, parceria_id: 1, remetente: 'admin', conteudo: 'Olá! Recebi a solicitação de parceria de HALLIM ALVES TAVARES. Em breve entraremos em contato.', data_mensagem: new Date('2026-05-27T14:44:39.760Z') },
      { id: 2, parceria_id: 1, remetente: 'escola', conteudo: 'ola', data_mensagem: new Date('2026-05-27T14:44:53.662Z') },
      { id: 3, parceria_id: 1, remetente: 'admin', conteudo: 'oi', data_mensagem: new Date('2026-05-27T14:45:17.204Z') }
    ];
  ...
  // Validar credenciais de gestor (gestores ou parcerias)
