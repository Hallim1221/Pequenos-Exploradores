...
class MockDatabase {
  constructor() {
    ...
    this.turmas = [
      ...
      { id: 2, nome: '1º Ano B', professor_id: 2, ano_escolar: '1º', instituicao_id: 1 },
      { id: 3, nome: '2º Ano A', professor_id: 3, ano_escolar: '2º', instituicao_id: 1 },
      
      // Turmas Instituição 2
      { id: 4, nome: '1º Ano A', professor_id: 4, ano_escolar: '1º', instituicao_id: 2 },
      { id: 5, nome: '2º Ano B', professor_id: 5, ano_escolar: '2º', instituicao_id: 2 },
      
      // Turmas Instituição 3
      { id: 6, nome: '1º Ano A', professor_id: 6, ano_escolar: '1º', instituicao_id: 3 },
      { id: 7, nome: '3º Ano C', professor_id: 7, ano_escolar: '3º', instituicao_id: 3 }
    ];
